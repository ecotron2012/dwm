...
static const char *projectscreen[] = {
    "sh", "-c",
    "xrandr --output eDP --mode 1920x1080 --output DisplayPort-0 --mode "
    "1920x1080 --same-as eDP",
    NULL};
...
static const char *openpassmenu[] = {"passmenu", NULL};
...
static const Key keys[] = {
    ...
    {0, XF86XK_AudioRaiseVolume, spawn,
     SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +5%; sigdwmblocks 2")},
    {0, XF86XK_AudioLowerVolume, spawn,
     SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -5%; sigdwmblocks 2")},
    {0, XF86XK_AudioMute, spawn,
     SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle; sigdwmblocks 2")},
    ...
    {MODKEY | ShiftMask, XK_c, spawn,
     SHCMD("st -t neomutt -e bash -ic neomutt")},
};
