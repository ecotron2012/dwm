...
static const char *fonts[]          = { "Symbols Nerd Font:size=12:antialias=true:autohint=true", "Hack Nerd Font Mono:size=10" };
...
static const char *openpassmenu[] = {"passmenu", "-fn", dmenufont,
	NULL };
